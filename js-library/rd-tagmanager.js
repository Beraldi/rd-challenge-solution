...
!(function() {
  ...
  var DA_Referer = (typeof(DA_SOURCE_URL) != "undefined") ? DA_SOURCE_URL : "null";
  ...
  var f = function() {
    ...
    this.sync = function(_cid, _url, _email) {
      var _src = DA_Endpoint + "/user/?cid=" + _cid + "&url=" + _url + "&email=" + _email;
  ...
  track.sync(DA_CLIENT_ID, window.location.href, "");
